                    ...
                    <option value="page-contact.htm">Contact</option>
						...
						<section class="tiles">
								<article class="style1">
									<span class="image">
										<img src="${ctx}/resources/images/1.jpg" alt="" />
									</span>
									<a href="generic.html">
										<h2>Restaurant</h2>
										<div class="content">
								...
								<article class="style2">
									<span class="image">
										<img src="${ctx}/resources/images/2.jpg" alt="" />
									</span>
									<a href="generic.html">
										<h2>Cafe</h2>
										<div class="content">
								...
								<article class="style3">
									<span class="image">
										<img src="${ctx}/resources/images/3.jpg" alt="" />
									</span>
									<a href="generic.html">
								...
								<article class="style4">
									<span class="image">
										<img src="${ctx}/resources/images/4.jpg" alt="" />
									</span>
									<a href="generic.html">
										<h2>Cinema</h2>
										<div class="content">
								...
								<article class="style5">
									<span class="image">
										<img src="${ctx}/resources/images/5.jpg" alt="" />
									</span>
									<a href="generic.html">
								...
								<article class="style6">
									<span class="image">
										<img src="${ctx}/resources/images/6.jpg" alt="" />
									</span>
									<a href="generic.html">
										<h2>Pension</h2>
										<div class="content">
								...
								<article class="style2">
									<span class="image">
										<img src="${ctx}/resources/images/pic07.jpg" alt="" />
									</span>
									<a href="generic.html">
										<h2>Ipsum</h2>
										<div class="content">
								...
								<article class="style3">
									<span class="image">
										<img src="${ctx}/resources/images/pic08.jpg" alt="" />
									</span>
									<a href="generic.html">
										<h2>Dolor</h2>
										<div class="content">
								...
								<article class="style1">
									<span class="image">
										<img src="${ctx}/resources/images/pic09.jpg" alt="" />
									</span>
									<a href="generic.html">
										<h2>Nullam</h2>
										<div class="content">
								...
								<article class="style5">
									<span class="image">
										<img src="${ctx}/resources/images/pic10.jpg" alt="" />
									</span>
									<a href="generic.html">
										<h2>Ultricies</h2>
										<div class="content">
								...
								<article class="style6">
									<span class="image">
										<img src="${ctx}/resources/images/pic11.jpg" alt="" />
									</span>
									<a href="generic.html">
										<h2>Dictum</h2>
										<div class="content">
								...
								<article class="style4">
									<span class="image">
										<img src="${ctx}/resources/images/pic12.jpg" alt="" />
									</span>
									<a href="generic.html">
										<h2>Pretium</h2>
										<div class="content">
