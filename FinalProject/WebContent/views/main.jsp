	...
	<div class="container">
		...
		<section class="tiles">
			<article class="style1">
				<span class="image"> <img src="${ctx}/resources/images/1.jpg"
					alt="" />
			...
			<article class="style2">
				<span class="image"> <img src="${ctx}/resources/images/2.jpg"
					alt="" />
				</span> <a href="generic.html">
					<h2>Cafe</h2>
					<div class="content">
			...
			<article class="style3">
				<span class="image"> <img src="${ctx}/resources/images/3.jpg"
					alt="" />
				</span> <a href="generic.html">
			...
			<article class="style4">
				<span class="image"> <img src="${ctx}/resources/images/4.jpg"
					alt="" />
				</span> <a href="generic.html">
					<h2>Cinema</h2>
					<div class="content">
			...
			<article class="style5">
				<span class="image"> <img src="${ctx}/resources/images/5.jpg"
					alt="" />
				</span> <a href="generic.html">
			...
			<article class="style6">
				<span class="image"> <img src="${ctx}/resources/images/6.jpg"
					alt="" />
				</span> <a href="generic.html">
					<h2>Pension</h2>
					<div class="content">
