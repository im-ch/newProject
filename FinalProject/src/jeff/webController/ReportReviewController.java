...
//   }
   ...
   public ModelAndView reportedReviewDetail(@RequestParam("reviewId") int reviewId){
	  ModelAndView modelAndView = new ModelAndView("reportedReviewDetail");
	  Review review = reviewService.findReviewByReviewId(reviewId);
	  ReportReview reportReview = service.findReportReview(reviewId);
	  modelAndView.addObject("review", review);
	  modelAndView.addObject("reportReview", reportReview);
      return modelAndView;
   }
